...
def Parse():
	...
	woofer_start_position = "0 0 %s"%(1)	# Initial position of the robot torso = 1 for free leg testing
	# woofer_start_position = "0 0 %s"%(0.3)	# Initial position of the robot torso = 0.3 for force testing
	...
	in_file 	= dir_path+"/woofer_fixed_base.xml"
	out_file 	= dir_path + "/woofer_fixed_base_out.xml"
